...
const ACTION_LABELS: Record<string, string> = {
  ...
  "route-groups.create": "Создание групп трасс",
  "route-group.update": "Изменение диапазона и баллов группы трасс",
  "route-group.add-routes": "Добавление трасс в группу",
  "route-group.delete": "Удаление пустой группы трасс",
